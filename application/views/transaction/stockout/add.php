...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="active"> Create Stock Out</li>
    </ol>
</section>
    ...
    <div class="box">
        <div class="box-header">
            <div class="pull-right">
                <a href="<?= base_url('stockout')?>" class="btn btn-xs btn-warning">
            ...
            <div class="col-lg-6 col-lg-offset-3">
                <form action="" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="detail" id="detail" class="form-control" placeholder="Masukan Detail Stock Out"><?= $this->input->post('detail');?></textarea>
                        <span class="text-red"><?= form_error('detail')?></span>
                    </div>
                    <div class="form-group">
                        <label for="qty">Qty <span class="text-red">*</span></label>
                        <input type="number" name="qty" id="qty" class="form-control" placeholder="Masukan Qty Stock Out" value="<?= $this->input->post('qty')?>">
